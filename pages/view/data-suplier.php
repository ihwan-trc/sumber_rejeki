    ...
    <div class="modal-content">
      ...
      <form method="POST" action="action/action?act=add-sup">
        <div class="form-group">
          ...
          <input type="hidden" name="kode" class="form-control" style="font-size: 12px" value="<?= $execute->kode+1 ?>">
        <div class="form-group">
          <label for="exampleFormControlInput1">Nama suplier</label>
          <input type="text" class="form-control" name="nama" style="font-size: 12px" required>
        <div class="form-group">
