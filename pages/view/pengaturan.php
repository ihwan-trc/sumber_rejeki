...
#idform{
 ...
 margin-bottom: -10px;
     ...
     <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <h5 align="center"><b>Pengaturan Toko</b></h5><hr>


                <form action="action/action.php?act=up-pengaturan" id="idform" class="form-horizontal form-label-left" method="post" >

              <?php $sql = $connect->query("SELECT * FROM data_toko");

              while ($data = $sql->fetch_object()) { ?>
                            
                           <div class="col-md-8" style="">
                           <div class="form-group">
                            <label class="control-label col-md-4 col-sm-3 col-xs-12" for="first-name"> Nama Toko <span class="required"></span></label>
                           ...
                           <div class="col-md-12">
                            ...
                            <div class="form-group">
                            <label class="control-label col-md-4 col-sm-3 col-xs-12" for="first-name"> Alamat <span class="required"></span></label>
                        ...
                        <div class="col-md-6">
                            <label for="exampleFormControlInput1">Edit Data barang</label><br>
                             <div class="btn-group btn-group-toggle" data-toggle="buttons">
