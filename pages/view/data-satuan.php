                ...
                <table class="table " id="dataTable" width="100%" cellspacing="0" style="font-size: 12px">
                  ...
                  <?php
                    ...
                    echo"
                      ...
                      <td align=center>
                        <a href='?p=satuan&&kode=$data->kode' class='btn btn-info btn-sm' title='edit'><span class='fa fa-edit'></span></a>
                        <a href='action/action?kode=$data->kode&&act=del-satuan' class='btn btn-danger btn-sm' title='hapus'><span class='fa fa-trash'></span></a>
                      </td>
                      </tr>";
                    $no++;
                  }?>
              ...
              ?>
                <form method="POST" action="action/action?act=up-satuan" style="font-size: 12px">
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Kode Satuan</label>
...
<?php else: ?>
                ...
                <form method="POST" action="action/action?act=add-satuan" style="font-size: 12px">
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Nama Satuan</label>
                    <input type="text" class="form-control" placeholder="Masukkan Nama Satuan" style="font-size: 12px" name="nama" autofocus required>
                  </div>
