...
<?php $sql = $connect->query("SELECT id, nama,qty,harga,subtotal FROM detail, barang WHERE barang.`kode` = detail.`kode_barang` AND id = '$get_struk' ");  while ($dt = $sql->fetch_object()) { ?>
	<tr>
...
<script>
	document.location.href='../../home?p=form-penjualan&&status=sukses';
</script>
