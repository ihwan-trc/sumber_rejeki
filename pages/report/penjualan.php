  ...
  <div class="card-body" >
    <form action="#"  method="POST">
        ...
        <div class="form-group sembunyikan"  id="data-shift">
          <label class="control-label col-md-2 col-sm-3 col-xs-12"> Pilih Kasir <span class="required" ></span></label>
          <div class="col-md-5 col-sm-6 col-xs-12">
              <select class="form-control" name="kasir" style="border-top-left-radius :  5px; border-bottom-left-radius :  5px; font-size: 14px;">
                <option disabled="" selected="">Pilih Salah Satu</option>
            <?php $sql = $connect->query("SELECT * FROM user");
      ...
      <div class="row">
            ...
            <div class="col-md-12 col-sm-6 col-xs-12">
              <div class="input-group">
                ...
                <span class="input-group-btn">
                  ...
                  <button type="submit" name='cari' class="btn btn-danger btn-sm" name="" style="font-size: 16px"><span class="fa fa-search"> Cari Data</span></button>
                </span>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4" style="padding-left: 25px" >
            <input type="checkbox" id="clicksift"> Tampilkan kasir
        </div>
      </div>
      ...
      <div class="form-group sembunyikan"  id="data-shift">
        ...
        <div class="col-md-5 col-sm-6 col-xs-12">
            <select class="form-control" name="kasir" style="border-top-left-radius :  5px; border-bottom-left-radius :  5px; font-size: 14px;">
              <option disabled="" selected="">Pilih Salah Satu</option>
              <?php $qr = $connect->query("SELECT * FROM user");
      ...
      <div style="padding-top: 20px;color : black;" >
        ...
        <table class="table table-keytable" style="font-size: 12px">
          ...
          <tbody>
            ...
            <?php $sql = $connect->query("SELECT * FROM detail, barang WHERE barang.kode = detail.kode_barang AND id='$a'");
          ...
          ?>
             <td colspan="6" align="right"><h4 style="font-size: 18px"><b style="color : black">Total Penjualan Bulan Ini : Rp. <?php echo number_format($q->total) ?>,-</b></h4></td>
                  ...
                  <?php }elseif ($_POST['kasir']) { $kasir = $_POST['kasir'];  echo '
                <h4 class="text-center">Laporan Penjualan</h4>
                <h5 class="text-center" style="font-size:14px">'. tgl_indo($_POST["awal"]) .' - '. tgl_indo($_POST['akhir']) .' </h5> 
                <h5 class="text-center" style="font-size:14px">kasir : '. $_POST["kasir"] .' </h5>'; 
