...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Nov 2021 pada 05.42
...
(1, '1001', 'Semen Tiga Roda 50 KG', 'PT.Abadi Sejahtera', 'Pasir dan Semen', 'sak', 40000, 45000, '0000-00-00', 100, 'aktif', 'buka', 'admin'),
(2, '1002', 'Semen Gresik 50 KG', 'PT.Abadi Sejahtera', 'Pasir dan Semen', 'sak', 48000, 53000, '0000-00-00', 150, 'aktif', 'buka', 'admin'),
(3, '1003', 'Semen Holcim 50 KG', 'PT.Abadi Sejahtera', 'Pasir dan Semen', 'sak', 45500, 50500, '0000-00-00', 150, 'aktif', 'buka', 'admin'),
(4, '2001', 'Kayu Meranti 2X3', 'CV.Bangun Sejahtera', 'Kayu / Bambu', 'batang', 5000, 7500, '0000-00-00', 50, 'aktif', 'buka', 'admin'),
(5, '2002', 'Kayu Meranti 3X4', 'CV.Bangun Sejahtera', 'Kayu / Bambu', 'batang', 10000, 15500, '0000-00-00', 45, 'aktif', 'buka', 'admin'),
(6, '2003', 'Kayu Meranti 4X6', 'CV.Bangun Sejahtera', 'Kayu / Bambu', 'batang', 20000, 27000, '0000-00-00', 30, 'aktif', 'buka', 'admin'),
(7, '2004', 'Kayu Meranti 5X7', 'CV.Bangun Sejahtera', 'Kayu / Bambu', 'batang', 38000, 42000, '0000-00-00', 20, 'aktif', 'buka', 'admin'),
(8, '2005', 'Kayu Meranti 5X10', 'CV.Bangun Sejahtera', 'Kayu / Bambu', 'batang', 65000, 70000, '0000-00-00', 20, 'aktif', 'buka', 'admin'),
(9, '2006', 'Kayu Meranti 6X12', 'CV.Bangun Sejahtera', 'Kayu / Bambu', 'batang', 85000, 94000, '0000-00-00', 20, 'aktif', 'buka', 'admin'),
(10, '2007', 'Kayu Meranti 8X12', 'CV.Bangun Sejahtera', 'Kayu / Bambu', 'batang', 125000, 130000, '0000-00-00', 20, 'aktif', 'buka', 'admin');
...
('TB.Sumber Rejeki', 'TB.Sumber Rejeki', 'Jl.Raya Ngantang Malang Jawa Timur', '085201202582', 'Buka', 'Toko Bangunan Terlengkap dan Termurah', 'buka');
...
(1, 'PT.Abadi Sejahtera', 'Ngantang', '081326344558', '', 'Jl.Arumba'),
(2, 'CV.Bangun Sejahtera', '', '', '', '');
...
--
-- Dumping data untuk tabel `temp_beli`
--

INSERT INTO `temp_beli` (`id`, `kode_barang`, `barcode`, `nama`, `satuan`, `beli`, `jual`, `diskon`, `qty`, `subtotal`, `pot`) VALUES
(NULL, 9, '897834', 'tes barang', 'batang', 4000, 5000, 0, 1, 4000, 0);
...
--
-- Struktur dari tabel `temp_edit_jual`
--

CREATE TABLE `temp_edit_jual` (
  `id` varchar(20) DEFAULT NULL,
  `kode_barang` int(11) DEFAULT NULL,
  `barcode` varchar(25) DEFAULT NULL,
  `nama` varchar(100) DEFAULT NULL,
...
--
-- Indeks untuk tabel `temp_edit_jual`
--
ALTER TABLE `temp_edit_jual`
  ADD KEY `id` (`id`),
  ADD KEY `kode_barang` (`kode_barang`) USING BTREE;
